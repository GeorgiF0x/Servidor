...
if (isset($_SESSION['usuario_id'])) {
    // Si hay sesión, mostrar botones para cerrar sesión y perfil
...
$albaranes = verTodosAlbaranes($_SESSION['usuario_id']);
...
<head>
    ...
    <title>Historial de Albaranes</title>
...
<body>
    <div class="container mt-5">
        ...
        <div class="col-3 bg-white d-flex justify-content-around align-items-center">
            <!-- ... (código para mostrar botones de cierre de sesión y perfil) ... -->
        </div>
    </header>
    <main>
        <div class="row mt-5">
