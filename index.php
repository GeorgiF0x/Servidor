...
<head>
  ...
  <!-- Incluye Bootstrap 5 desde un CDN -->
            ...
            <ul class="list-group" id="practicas-list">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center fs-4 fw-bold fst-italic">
                <div class="d-flex align-items-center">
                  ...
                  Tarea Notas Con ficheros
                </div>
                <a href="./Tema3/Tareas/PR10.2/notas.php" class="btn btn-dark text-white fw-bold">Ver tarea</a>
              </li>
            </ul>
          </div>
          ...
          <div class="col-md-6">
            ...
            <ul class="list-group" id="ejercicios-list">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center fs-4 fw-bold fst-italic">
                ...
                <a href="./Tema3/Tareas/PR12/informe.php" class="btn btn-dark text-white fw-bold">Ver tarea</a>
              </li>
            </ul>
          </div>
        </div>
