...
create user sesiones identified by 'seguro';
use sesiones;
grant all on sesiones.* to sesiones;
...
-- 	codigoPerfil char(5) not null,
-- 	codigoMenu char(5) not null,
-- 	primary key (codigoPerfil,codigoMenu),
-- 	index (codigoPerfil),
-- 	foreign key (codigoPerfil) references perfil (codigo),
-- 	index (codigoMenu),
...
insert into usuarios (usuario,clave, nombre, correo,perfil) values ('u5','833fa9facda9dd38c14f8f800df82e287d3a3974','georgi borisov','gba@correo.es','P0002');
